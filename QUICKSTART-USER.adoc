...
// Replace project-wharf, Project Wharf — See README.adoc for details., just run, Project Wharf started successfully. with actuals
= project-wharf — Quick Start for Users
:toc:
:toclevels: 2

== What is project-wharf?

Project Wharf — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./project-wharf-portable
----
...
[source]
----
Project Wharf started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/project-wharf/wiki
