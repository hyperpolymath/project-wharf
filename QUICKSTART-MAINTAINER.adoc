...
// Replace project-wharf, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= project-wharf — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining project-wharf for
...
* Upstream: https://github.com/hyperpolymath/project-wharf/issues
